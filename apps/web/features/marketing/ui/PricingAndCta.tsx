      ...
      <section className="py-32 relative bg-[#0D1117] border-y border-white/5">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-secondary text-lg">Transparent pricing for engineering teams of all sizes.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-surface-container/40 rounded-3xl p-10 border border-white/5 flex flex-col transition-all hover:border-primary/30">
              <div className="mb-8">
                <h4 className="text-secondary text-[11px] uppercase tracking-widest font-bold mb-2">Developer</h4>
              ...
              <ul className="space-y-4 mb-12 flex-grow">
                {['100k requests/mo', '3-day retention', 'Community support'].map(f => (
                  <li key={f} className="flex items-center gap-3 text-sm text-primary-foreground">
                    <Check className="text-primary w-5 h-5 shrink-0" /> {f}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-primary rounded-3xl p-10 border-2 border-primary relative flex flex-col shadow-[0_20px_50px_-12px_rgba(255,69,0,0.5)] scale-105 z-10">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white text-primary px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl">Recommended</div>
              <div className="mb-8">
                <h4 className="text-primary text-[11px] uppercase tracking-widest font-bold mb-2">Pro Team</h4>
                <div className="flex items-baseline gap-1 text-white">
                  <span className="text-5xl font-black">$49</span>
                  <span className="text-primary text-sm">/mo</span>
                </div>
              </div>
              ...
              <button className="w-full py-4 rounded-xl bg-white text-primary font-black hover:scale-[1.02] transition-all shadow-lg">Start Pro Trial</button>
            </div>

            <div className="bg-surface-container/40 rounded-3xl p-10 border border-white/5 flex flex-col transition-all hover:border-primary/30">
              <div className="mb-8">
                <h4 className="text-secondary text-[11px] uppercase tracking-widest font-bold mb-2">Enterprise</h4>
                <div className="flex items-baseline gap-1 text-white">
