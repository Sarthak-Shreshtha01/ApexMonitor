        ...
        <table className="w-full text-left min-w-[600px]">
          <thead>
            <tr className="bg-surface-container-high/30">
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.15em] text-secondary">Method</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.15em] text-secondary">Endpoint</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.15em] text-secondary">Requests</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.15em] text-secondary">Avg Latency</th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.15em] text-secondary">Status</th>
            </tr>
          </thead>
